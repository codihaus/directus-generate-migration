...
module.exports = class FieldClass {
	...
	constructor(knex) {
		...
		this.fieldDefault = {
			...
			code: (options) => this.generateNormal("string" , {
				meta: {
			...
			toggle: (options) => this.generateNormal("string" , {
				meta: {
					interface: "boolean" ,
			...
			checkBoxes: (choices , options) => this.generateNormal("string" , {
				meta: {
			...
			wysiwyg: (options) => this.generateNormal("string" , {
				meta: {
			...
			textArea: (options) => this.generateNormal("string" , {
				meta: {
