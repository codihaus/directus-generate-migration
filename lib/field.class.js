...
module.exports = class FieldClass {
	...
	generateM2o(related_collection,meta ={},schema = {},relations_options){
		return {
			type: "$M2O$",
			schema: {
				...schema
	...
	async readAll(collection){
		return this.fieldsService.readAll(collection).catch(e=>{
			console.log("Error readAll: ",e)
		})
	}

	async createField(data){
		return this.fieldsService.createField(data).catch(e=>{
			console.log("Error createField: ",e)
		})
	}

	async deleteField(data){
		return this.fieldsService.deleteField(data).catch(e=>{
